...
public class TerdekatActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spWisata.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Object itemDB = parent.getItemAtPosition(position);
    ...
    private void setID() {
        ...
        ArrayAdapter<String> adpWisata = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, sWisata);
    ...
    private void initMap() {
        ...
        ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[] {ACCESS_FINE_LOCATION}, 115);
            return;
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        new TerdekatActivity.PlacesTask().execute(sb);
        stopProg();
    ...
    public class PlacesTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            new TerdekatActivity.ParserTask().execute(result);
        }
    }
